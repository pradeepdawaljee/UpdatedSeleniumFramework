...
public class CommonMethods extends BaseClass {
	...
	public static void sendKeys(By element,String sendKeysValue,String stepDescription) throws Exception{
		...
		if(isElementPresent(element)){
			...
			if(isScreenShotRequiredForPassedStep.startsWith("Y")||isScreenShotRequiredForPassedStep.startsWith("y")||isScreenShotRequiredForPassedStep.startsWith("T")||isScreenShotRequiredForPassedStep.startsWith("t")) {
				extentTest.log(LogStatus.PASS, stepDescription+" Successfully",captureScreenshot());
			}
			else {
				extentTest.log(LogStatus.PASS, stepDescription+" Successfully");
			}
